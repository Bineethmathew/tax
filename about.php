...
<body>
	...
	<div style="margin-left:30%; width:40%; height:50%;"><p style="color:white;">
	<p>Headquartered in  pala,Taxigo provides taxi service all over kerala. 
...
<tr><td>			<form action="#" method="post">
				<div class="row vehicle-img text-center">
					...
					<img src="upload/toyota-innova.png" alt="" width=280 height=170>
				</div>
				<div class="row specification" style="border-radius:1px;" >
					<ul class="nav">
					<span><script> d </script></span>
						<li><span><img src="images/icons/fleet2/1.png" alt=""></span>innova</li>
						<li><span><img src="images/icons/fleet2/3.png" alt=""></span>&nbsp&nbsp&nbsp&nbsp&nbsp5</li>
						<li><span><img src="images/icons/fleet2/4.png" alt=""></span>&nbsp&nbsp&nbsp&nbsp&nbsp2013</li>
						
					</ul>
					<input type="hidden" value="1"  name="vid">
				...
				<div class="row vehicle-img text-center">
					...
					<img src="upload/maruti-swift.png" alt="" width=280 height=180>
				</div>
				<div class="row specification" style="border-radius:10px;">
					<ul class="nav">
					<span><script> d </script></span>
						<li><span><img src="images/icons/fleet2/1.png" alt=""></span>swift</li>
						<li><span><img src="images/icons/fleet2/3.png" alt=""></span>&nbsp&nbsp&nbsp&nbsp&nbsp6</li>
						<li><span><img src="images/icons/fleet2/4.png" alt=""></span>&nbsp&nbsp&nbsp&nbsp&nbsp2016</li>
				...
				<div class="row vehicle-img text-center">
					...
					<img src="upload/eno.png" alt="" width=280 height=180>
				</div>
				<div class="row specification" style="border-radius:10px;">
					<ul class="nav">
					<span><script> d </script></span>
						<li><span><img src="images/icons/fleet2/1.png" alt=""></span>eon</li>
						<li><span><img src="images/icons/fleet2/3.png" alt=""></span>&nbsp&nbsp&nbsp&nbsp&nbsp8</li>
						<li><span><img src="images/icons/fleet2/4.png" alt=""></span>&nbsp&nbsp&nbsp&nbsp&nbsp2016</li>
						
					</ul>
					<input type="hidden" value="3"  name="vid">
					<!--<input type="submit" name="selcar" class="details-page" value="+">-->
					</form>
				</div>
				...
				<div class="row vehicle-img text-center">
					...
					<img src="upload/Alto-800.png" alt="" width=280 height=180>
				</div>
				<div class="row specification" style="border-radius:10px;">
					<ul class="nav">
					<span><script> d </script></span>
						<li><span><img src="images/icons/fleet2/1.png" alt=""></span>alto</li>
						<li><span><img src="images/icons/fleet2/3.png" alt=""></span>&nbsp&nbsp&nbsp&nbsp&nbsp8</li>
						<li><span><img src="images/icons/fleet2/4.png" alt=""></span>&nbsp&nbsp&nbsp&nbsp&nbsp2017</li>
						
					</ul>
					<input type="hidden" value="4"  name="vid">
					<!--<input type="submit" name="selcar" class="details-page" value="+">-->
					</form>
				</div>
				...
				<div class="row vehicle-img text-center">
					...
					<img src="upload/wagonar.png" alt="" width=280 height=180>
				</div>
				<div class="row specification" style="border-radius:10px;">
					<ul class="nav">
					<span><script> d </script></span>
						<li><span><img src="images/icons/fleet2/1.png" alt=""></span>wagonar</li>
						<li><span><img src="images/icons/fleet2/3.png" alt=""></span>&nbsp&nbsp&nbsp&nbsp&nbsp4</li>
						<li><span><img src="images/icons/fleet2/4.png" alt=""></span>&nbsp&nbsp&nbsp&nbsp&nbsp2016</li>
						
					</ul>
					<input type="hidden" value="5"  name="vid">
					<!--<input type="submit" name="selcar" class="details-page" value="+">-->
					</form>
				</div>
	...
	<div class="container"> 
					...
					<div class="inner row m0">
						<p>Amazing taxi services </p>
							...
							<i class="fa fa-star"></i>
												...
												<h5 class="client">vishnu vijayan</?></h5>
						<a href="#" class="client-img"><img src="upload/vishnu.jpg" alt="" class="img-circle"></a>
					</div>
				</div>
			</div>   				
		</div>
					...
					<div class="inner row m0">
						<p>amazing cars</p>
							...
							<i class="fa fa-star"></i>
												...
												<h5 class="client">Deepu Mohandas</?></h5>
						<a href="#" class="client-img"><img src="upload/deepu.jpg" alt="" class="img-circle"></a>
					</div>
				</div>
			</div>   				
		</div>
		...
		<div class="row">
			<div class="testimonial-carousel">
				<div class="item testimonial">
					<div class="inner row m0">
						<p>Best Online taxi booking service</p>
												<span class="stars">
							<i class="fa fa-star"></i>
						</span>
												<span class="stars">
...
<h3 style="color:pink;margin-left:18%; margin-top:-4%;">REGISTRATION</h3><br />
      			...
      			<form action="userreg.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return val();"  >
					<table style="width:100%; cellpadding:5%; margin-left:18%;margin-top:-2%;">
						<tr><td>first name<span style="color:red;">*</span>:</td> <td><input type="text" id="fn" name="fname"  onchange="return n11();" required></td>
						<tr><td>last name<span style="color:red;">*</span>:</td> <td><input type="text" name="lname"  maxlength="10" required></td></tr>
						<tr><td>password<span style="color:red;">*</span>:</td> <td><input type="password" name="pass" maxlength="10" required></td></tr>

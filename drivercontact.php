...
Mob: 9496130053 / +91 7025 522 671</p>
...
<p style="color:white; margin-left:-150%;">Near sjcet college pala,</p>
<p style="color:white; margin-left:-150%;">Kottayam. Pincode - 656586
	</p>
	</div>
	<div id="map" style="border:2px solid white; width:50%; height:300px; margin-left:50%; margin-top:-20%;">
		...
		<script>
function myMap() {
  var myCenter = new google.maps.LatLng(9.724433,76.7279104);

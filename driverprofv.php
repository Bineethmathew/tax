				...
				<div class="col-sm-9 col-xs-4 info-box">
					<div class="header-informations hidden-xs">
						...
						<div class="media info-media">
							...
							<div class="media-body">
								<h5 class="this-top">+91-949130053</h5>
								<h5 class="this-bottom">bineehmathew10@gmail.com</h5>
							</div>
						</div>
						<div class="media info-media">
...
<form name="myform" action="driverprofedit.php" method="post">
    ...
    <tr><td><p style="color:white"> first name:</p></td><td><input style="color:#f77d0a" type="text" name="firstname" value="<?php echo $row['fname']?>"></td></tr>
	<tr><td><p style="color:white">last name:</p></td><td><input style="color:#f77d0a" type="text" name="lastname" value="<?php echo $row['lname']?>"></td></tr>
